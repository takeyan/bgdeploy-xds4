...
// 	var upstreamPortUint32 uint64
//     upstreamPortUint32,_ = strconv.ParseUint(upstreamPortnumber,10,32)
// //	snap, _ := cache.NewSnapshot(snapshotVersion,
// 	snap := cache.NewSnapshot(snapshotVersion,
// 			map[resource.Type][]types.Resource{
// 					resource.ClusterType:  {makeCluster2(ClusterName, upstreamHostname, uint32(upstreamPortUint32))},
// 					resource.RouteType:    {makeRoute2(RouteName, ClusterName, upstreamHostname)},
// 					resource.ListenerType: {makeHTTPListener(ListenerName, RouteName)},
// 			},
// 	)
// 	return snap
